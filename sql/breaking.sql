...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2012 a las 14:17:34
...
CREATE TABLE IF NOT EXISTS `blog` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Blogs de nodo o proyecto' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Comentarios' AUTO_INCREMENT=2 ;

--
-- Volcado de datos para la tabla `comment`
--

INSERT INTO `comment` (`id`, `post`, `date`, `text`, `user`) VALUES
(1, 3, '2012-11-06 14:34:43', 'A en Marcos li sembla que es mereix un 10', 'carlos');
...
CREATE TABLE IF NOT EXISTS `feed` (
  ...
  KEY `scope` (`scope`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log de eventos' AUTO_INCREMENT=7 ;
...
(1, 'nueva entrada blog Goteo (admin)', '/admin/blog', '2012-11-06 14:31:02', 'admin', 'admin', 'El admin <a href="/user/profile/carlos" class="blue" target="_blank">carlos</a> ha <span class="red">Publicado</span> en el blog Goteo la entrada "<a href="/blog/3" class="grey" target="_blank">Estrenem Blog de Breaking Bad</a>"', NULL),
(2, 'Estrenem Blog de Breaking Bad', '/blog/3', '2012-11-06 14:31:02', 'public', 'goteo', '<p>\r\n	Per f&iacute; podem veure els resultats del treball del equips de la UdG amb aquesta magn&iacute;fica p&agrave;gina web.<br />\r\n	Esperem que us agradi a tots.<br />\r\n	<br />\r\n	Carlos Velasco &amp; Norbert Figueras</p>', NULL),
(3, 'nueva entrada blog Goteo (admin)', '/admin/blog', '2012-11-06 14:33:33', 'admin', 'admin', 'El admin <a href="/user/profile/carlos" class="blue" target="_blank">carlos</a> ha <span class="red">Publicado</span> en el blog Goteo la entrada "<a href="/blog/3" class="grey" target="_blank">Estrenem Blog de Breaking Bad</a>"', NULL),
(4, 'nueva entrada blog Goteo (admin)', '/admin/blog', '2012-11-06 14:33:47', 'admin', 'admin', 'El admin <a href="/user/profile/carlos" class="blue" target="_blank">carlos</a> ha <span class="red">Publicado</span> en el blog Goteo la entrada "<a href="/blog/3" class="grey" target="_blank">Estrenem Blog de Breaking Bad</a>"', NULL),
(5, 'usuario escribe comentario en blog/novedades', '/admin/projects', '2012-11-06 14:34:45', 'admin', 'user', '<a href="/user/profile/carlos" class="blue" target="_blank">carlos</a> ha escrito un <span class="green">Comentario</span> en la entrada "<a href="/blog/3#comment1" class="grey" target="_blank">Estrenem Blog de Breaking Bad</a>" del blog de <a href="/blog//" class="grey" target="_blank">Goteo</a>', NULL),
(6, 'carlos', '/user/profile/carlos', '2012-11-06 14:34:45', 'public', 'community', 'Ha escrito un <span class="green">Comentario</span> en la entrada "<a href="/blog/3#comment1" class="grey" target="_blank">Estrenem Blog de Breaking Bad</a>" del blog de <a href="/blog//" class="grey" target="_blank">Goteo</a>', 1);
...
(2, 'avatar_1.png', 'image/png', 70424);
...
--
-- Volcado de datos para la tabla `page_node`
--

INSERT INTO `page_node` (`page`, `node`, `lang`, `content`) VALUES
('about', 'goteo', 'es', '<p>\r\n	Goteo es una red social de financiaci&oacute;n colectiva (aportaciones monetarias) y colaboraci&oacute;n distribuida (servicios, infraestructuras, microtareas y otros recursos). Una plataforma para la inversi&oacute;n de &ldquo;capital riego&rdquo; en proyectos que contribuyan al desarrollo del procom&uacute;n, el c&oacute;digo abierto y/o el conocimiento libre. Una comunidad para apoyar el desarrollo aut&oacute;nomo de iniciativas creativas e innovadoras cuyos fines sean de car&aacute;cter social, cultural, cient&iacute;fico, educativo, tecnol&oacute;gico o ecol&oacute;gico, que generen nuevas oportunidades para la mejora constante de la sociedad.</p>\r\n<p>\r\n	&nbsp;</p>\r\n'),
('contact', 'goteo', 'es', '<div class="contact-info" style="color: #58595b; width: 360px; font-size: 12px;	padding: 5px; line-height: 16px;">\r\n	<span class="intro-tit" style="font-size: 21px; font-weight: bold; line-height: 24px;">Quiz&aacute;s estos links resuelvan r&aacute;pidamente lo que buscas: </span>\r\n	<ul style="margin-left: 0; 	padding-left: 0;">\r\n		<li style="color: #38b5b1; 	margin-left: 0;	padding-left: 0; list-style-position: inside; padding-top: 2px;	padding-bottom: 2px;">\r\n			<a href="http://www.goteo.org/faq" style="color: #38b5b1; text-decoration: none;" target="_blank">FAQ - Preguntas frecuentes</a></li>\r\n		<li style="color: #38b5b1; 	margin-left: 0;	padding-left: 0; list-style-position: inside; padding-top: 2px;	padding-bottom: 2px;">\r\n			<a href="http://www.goteo.org/glossary" style="color: #38b5b1; text-decoration: none;" target="_blank">El Glosario de la microfinanciaci&oacute;n</a></li>\r\n		<li style="color: #38b5b1; 	margin-left: 0;	padding-left: 0; list-style-position: inside; padding-top: 2px;	padding-bottom: 2px;">\r\n			<a href="http://www.goteo.org/press" style="color: #38b5b1; text-decoration: none;" target="_blank">Kit de prensa Goteo</a></li>\r\n		<li style="color: #38b5b1; 	margin-left: 0;	padding-left: 0; list-style-position: inside; padding-top: 2px;	padding-bottom: 2px;">\r\n			<a href="http://www.goteo.org/service/workshop" style="color: #38b5b1; text-decoration: none;" target="_blank">Talleres</a></li>\r\n	</ul>\r\n	Goteo es una plataforma digital para la financiaci&oacute;n colectiva, colaboraci&oacute;n y distribuci&oacute;n de recursos para el desarrollo de proyectos sociales, culturales, educativos, tecnol&oacute;gicos... que contribuyan al fortalecimiento del procom&uacute;n, el c&oacute;digo abierto y/o el conocimiento libre.</div>\r\n'),
('howto', 'goteo', 'es', '<div style="width:430px; float:left">\r\n	<div style="font-size:14px; line-height:19px; padding-right:16px; margin-top:16px;">\r\n		Goteo es una plataforma para apoyar proyectos de emprendedores, innovadores sociales y creativos que tengan entre sus objetivos, formato y/o resultado final, de forma total o significativa, alg&uacute;n tipo de retorno colectivo regido por una licencia libre o abierta (por ejemplo Creative Commons o GPL).\r\n		<p>\r\n			Esto es, proyectos con &quot;ADN abierto&quot; en los que se comparte informaci&oacute;n, conocimiento, contenidos digitales y/u otros recursos relacionados con la actividad para la que se busca financiaci&oacute;n.<br />\r\n			<br />\r\n			Goteo se gu&iacute;a por las siguientes condiciones y requisitos, que debes conocer si quieres proponer un proyecto para que opte a ser cofinanciado y recibir la ayuda de la comunidad de Goteo. Si necesitas m&aacute;s informaci&oacute;n sobre cualquiera de los siguientes puntos te recomendamos leer <a href="http://www.goteo.org/faq">nuestras FAQ</a>.</p>\r\n	</div>\r\n	<p>\r\n		&nbsp;</p>\r\n	<form action="/project/create" method="post">\r\n		<input class="checkbox" id="create_accept" name="confirm" type="checkbox" value="true" />&nbsp;<span style="font-size:12px;"><label class="unselected" for="create_accept">He le&iacute;do, entiendo y acepto las condiciones y requisitos para crear un proyecto en Goteo, as&iacute; como la <a href="http://www.goteo.org/legal/privacy">pol&iacute;tica de privacidad</a> de la plataforma.</label><br />\r\n		</span>\r\n		<p>\r\n			<span style="font-size:12px;">&nbsp;</span></p>\r\n		<span style="font-size:12px;"><button class="disabled" disabled="disabled" id="create_continue" name="action" type="submit" value="continue">Continuar</button></span></form>\r\n</div>\r\n<div style="width:430px; float:right; padding-right:16px; margin-top:16px;">\r\n	<span style="font-size:14px;">Condiciones</span>\r\n	<p>\r\n		<span style="color:#808285; line-height:16px;">1. Cuando mi proyecto ofrezca recompensas individuales a cambio de aportaciones econ&oacute;micas determinadas, deber&eacute; cumplir con el compromiso establecido con la plataforma y mis cofinanciadores en caso de obtener la financiaci&oacute;n m&iacute;nima solicitada.<br />\r\n		<br />\r\n		<strong>2</strong>. Deber&eacute; cumplir igualmente con el compromiso de publicar los retornos colectivos prometidos, enlaz&aacute;ndolos desde la plataforma Goteo bajo la licencia elegida en el momento de solicitar la financiaci&oacute;n, en cumplimiento de un contrato legal con la Fundaci&oacute;n Fuentes Abiertas.<br />\r\n		<br />\r\n		<strong>3.</strong> Solicitar&eacute; una cofinanciaci&oacute;n m&iacute;nima para llevar a cabo el proyecto y otra &oacute;ptima. La recaudaci&oacute;n de la cofinanciaci&oacute;n m&iacute;nima coincidir&aacute; con el inicio de la producci&oacute;n, sobre la que deber&eacute; ir informando peri&oacute;dicamente, lo que me permitir&aacute; emprender una segunda ronda de cofinanciaci&oacute;n hasta llegar a la financiaci&oacute;n &oacute;ptima. &nbsp;<br />\r\n		<br />\r\n		<strong>4</strong>. La finalidad del proyecto no es la venta encubierta de productos o servicios ya producidos, ni de financiar campa&ntilde;as de beneficencia, pol&iacute;ticas o de cualquier otro tipo, ni delictiva o para atentar contra la dignidad de las personas.</span></p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span style="font-size:14px;">Requisitos</span></p>\r\n	<p>\r\n		<span style="color:#808285; line-height:16px;">&middot; Soy mayor de 18 a&ntilde;os.</span><br />\r\n		<span style="color:#808285; line-height:16px;">&middot; Dispongo de una cuenta bancaria.</span></p>\r\n</div>\r\n<div style="font-size:11px; color:#808285; float:left; clear:left; margin-top:20px; margin-right:10px; ">\r\n	Ud. presta su consentimiento para el tratamiento de sus datos personales. A tal efecto, el responsable del portal ha establecido una <a href="http://www.goteo.org/legal/privacy">pol&iacute;tica de privacidad</a> donde Ud. podr&aacute; conocer la finalidad que se le dar&aacute;n a los datos suministrados a trav&eacute;s del presente formulario, as&iacute; como los derechos que le asisten.</div>\r\n'),
('privacy', 'goteo', 'es', '<div class="estatic-txt0">\r\n	En cumplimiento de la Ley Org&aacute;nica 15/1999, de 13 de diciembre, de Protecci&oacute;n de Datos de Car&aacute;cter Personal, le informamos que los datos personales que nos suministre a trav&eacute;s de la activaci&oacute;n de su cuenta en <strong>GOTEO</strong> pasar&aacute;n a formar parte de un fichero titularidad de <strong>FUNDACION FUENTES ABIERTAS</strong>. Sus datos de car&aacute;cter personal ser&aacute;n utilizados para la gesti&oacute;n y administraci&oacute;n de la plataforma consistente en la posibilidad de apoyar y financiar proyectos emprendedores, as&iacute; como para la puesta en contacto entre los miembros de la misma.\r\n	\r\n<p>\r\nAsimismo le informamos que puede ejercitar sus derechos de <a href="http://www.goteo.org/user/login">acceso</a>, <a href="http://www.goteo.org/dashboard/profile">rectificaci&oacute;n</a>, <a href="http://www.goteo.org//user/leave">cancelaci&oacute;n</a> y oposici&oacute;n.\r\n</p>\r\n\r\n	<p>\r\nEn todo momento el usuario debe ser consciente que est&aacute; accediendo a una plataforma abierta para apoyar proyectos de emprendedores, innovadores sociales y creativos cuyo objetivo es la puesta en com&uacute;n de sus proyectos, necesidades, etc. por ello acepta y consiente que sus datos puedan ser accesibles a otros miembros de la plataforma. El usuario tiene la posibilidad de establecer el grado de privacidad de sus datos.</p>\r\n	<p>\r\n		En ning&uacute;n caso los responsables de <strong>GOTEO</strong> venden, alquilan ni ponen a disposici&oacute;n de terceras personas los datos personales proporcionados por los Usuarios de la plataforma.</p>\r\n	<p>\r\n		El Usuario garantiza que los datos personales facilitados son veraces y se hace responsable de informar sobre cualquier modificaci&oacute;n en los mismos. El Usuario ser&aacute; el &uacute;nico responsable de cualquier da&ntilde;o o perjuicio, directo o indirecto, que pudiera ocasionar a los responsables de <strong>GOTEO</strong> o a cualquier tercero a causa de la cumplimentaci&oacute;n de los formularios con datos falsos, inexactos, incompletos o no actualizados. En el caso de que deban incluirse datos de car&aacute;cter personal referentes a personas f&iacute;sicas distintas de la que cumplimenta el presente formulario deber&aacute;, con car&aacute;cter previo a su inclusi&oacute;n, informarles de los extremos contenidos en los p&aacute;rrafos anteriores.</p>\r\n</div>\r\n<div class="estatic-txt1">\r\n	<strong>GOTEO</strong> ha adoptado las medidas necesarias para evitar la alteraci&oacute;n, p&eacute;rdida, tratamiento o acceso no autorizado de los datos personales, habida cuenta en todo momento del estado de la tecnolog&iacute;a, no obstante, el usuario debe ser consciente de que las medidas de seguridad en Internet no son inexpugnables.\r\n	<p>\r\n		Esta p&aacute;gina web utiliza Google Analytics, un servicio anal&iacute;tico de web prestado por Google, Inc., una compa&ntilde;&iacute;a de Delaware cuya oficina principal est&aacute; en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (&quot;Google&quot;). Google Analytics utiliza &quot;cookies&quot;, que son archivos de texto ubicados en su ordenador, para ayudar al website a analizar el uso que hacen los usuarios del sitio web. La informaci&oacute;n que genera la cookie acerca de su uso del website (incluyendo su direcci&oacute;n IP) ser&aacute; directamente transmitida y archivada por Google en los servidores de Estados Unidos. Google usar&aacute; esta informaci&oacute;n por cuenta nuestra con el prop&oacute;sito de seguir la pista de su uso del website, recopilando informes de la actividad del website y prestando otros servicios relacionados con la actividad del website y el uso de Internet. Google podr&aacute; transmitir dicha informaci&oacute;n a terceros cuando as&iacute; se lo requiera la legislaci&oacute;n, o cuando dichos terceros procesen la informaci&oacute;n por cuenta de Google. Google no asociar&aacute; su direcci&oacute;n IP con ning&uacute;n otro dato del que disponga Google. Puede Usted rechazar el tratamiento de los datos o la informaci&oacute;n rechazando el uso de cookies mediante la selecci&oacute;n de la configuraci&oacute;n apropiada de su navegador, sin embargo, debe Usted saber que si lo hace puede ser que no pueda usar la plena funcionabilidad de este website. Al utilizar este website Usted consiente el tratamiento de informaci&oacute;n acerca de Usted por Google en la forma y para los fines arriba indicados.</p>\r\n</div>\r\n'),
('terms', 'goteo', 'es', '<div class="estatic-txt2">\r\n	<p>\r\n		<strong>FUNDACION FUENTES ABIERTAS</strong> (en adelante FFA), impulsora de <strong>GOTEO</strong> cumple con los requisitos establecidos en la Ley 34/2002, de 11 de Julio, de Servicios de la Sociedad de la Informaci&oacute;n y Comercio Electr&oacute;nico, en la Ley 56/2007, de 28 de diciembre de Medidas de Impulso de la Sociedad de la Informaci&oacute;n, as&iacute; como en la Ley Org&aacute;nica 15/1999, de 13 de diciembre, sobre Protecci&oacute;n de Datos de Car&aacute;cter Personal y su normativa de desarrollo (RD 1720/2007, de 21 de diciembre, por el que se aprueba el Reglamento de Desarrollo de la Ley Org&aacute;nica 15/1999 de Protecci&oacute;n de Datos de Car&aacute;cter Personal) a tal fin ha creado las siguientes condiciones de uso:</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<h3>\r\n		<span class="estatic-blue-green">FUNDACION FUENTES ABIERTAS</span></h3>\r\n	<p>\r\n		Las presentes Condiciones de Uso regulan el acceso y la utilizaci&oacute;n de la plataforma, incluyendo los contenidos y los servicios puestos a disposici&oacute;n de los Usuarios en y/o a trav&eacute;s de la Comunidad, bien por la FUNDACION, bien por sus Usuarios, bien por cualesquiera terceros.</p>\r\n	<p>\r\n		Asimismo, dentro de la plataforma existe la posibilidad de que el usuario acceda a la zona para crear o apoyar proyectos, estar&aacute; sujeta a unas condiciones particulares.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>PRIMERO: OBJETO DEL SERVICIO</strong></span></p>\r\n	<p>\r\n		GOTEO ofrece principalmente un servicio gratuito donde, los Usuarios registrados, podr&aacute;n acceder a una plataforma abierta para proponer o apoyar proyectos de emprendedores, innovadores sociales y creativos, as&iacute; como la puesta en com&uacute;n entre los usuarios de la plataforma.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>SEGUNDO: CONDICIONES</strong></span></p>\r\n	<p>\r\n		El uso de GOTEO se sujetar&aacute; a las siguientes Condiciones, las cuales podr&aacute;n ser actualizadas peri&oacute;dicamente, no obstante GOTEO avisar&aacute; de la modificaci&oacute;n de las Condiciones Generales o de la Pol&iacute;tica de Privacidad. Si el Usuario decide no aceptar las Condiciones deber&aacute; abstenerse de acceder y/o utilizar los contenidos y/o servicios ofrecidos en la plataforma.</p>\r\n	<p>\r\n		GOTEO se reserva el derecho de mejorar, modificar o suprimir, unilateralmente y sin previo aviso, servicios y/o contenidos de dicha Comunidad atendiendo a los m&aacute;s diversos criterios.</p>\r\n	<p>\r\n		Obligaci&oacute;n de hacer un uso correcto del portal: El Usuario se compromete a hacer un uso adecuado de la plataforma y a no emplearla para incurrir en actividades il&iacute;citas o contrarias a la buena fe y al ordenamiento legal (a t&iacute;tulo meramente indicativo y no exhaustivo); provocar da&ntilde;os en los sistemas f&iacute;sicos y l&oacute;gicos del responsable, de sus proveedores o de terceras personas, introducir o difundir en la red virus inform&aacute;ticos o cualesquiera otros sistemas f&iacute;sicos o l&oacute;gicos que sean susceptibles de provocar los da&ntilde;os anteriormente mencionados, sin olvidar todos aquellos que vulneren o transgredan el honor, la intimidad personal o familiar y a la imagen de las personas, de los derechos de propiedad y de toda otra naturaleza pertenecientes a un tercero como consecuencia de la transmisi&oacute;n, difusi&oacute;n, almacenamiento, puesta a disposici&oacute;n, recepci&oacute;n, obtenci&oacute;n o acceso a los contenidos o la imagen de terceros; la realizaci&oacute;n de actos de competencia desleal y publicidad il&iacute;cita como consecuencia de la transmisi&oacute;n, difusi&oacute;n, almacenamiento, puesta a disposici&oacute;n, recepci&oacute;n, obtenci&oacute;n o acceso a los contenidos; la falta de veracidad, exactitud, exhaustividad, pertinencia y/o actualidad de los contenidos dejando el Usuario, en todo caso, indemne a GOTEO frente a cualquier reclamaci&oacute;n, judicial o extrajudicial.</p>\r\n	<p>\r\n		El Usuario es el &uacute;nico responsable de los contenidos y ficheros puestos a disposici&oacute;n en el portal, por ello se obliga a no publicar (o subir) ning&uacute;n fichero (enti&eacute;ndase v&iacute;deo, audio, texto, etc.) que est&eacute; sujeto a derechos de propiedad intelectual (o industrial) de terceros, salvo que el titular legal de dichos derechos le haya otorgado una licencia o autorizaci&oacute;n formal conforme a la licencia que rige en el presente portal.</p>\r\n	<p>\r\n		GOTEO excluye cualquier responsabilidad por los da&ntilde;os y perjuicios de toda naturaleza que puedan deberse a los contenidos prestados o suministrados por cualesquiera terceros ajenos.</p>\r\n	<p>\r\n		Uso y Custodia del nombre de Usuario y de la contrase&ntilde;a. El Usuario se compromete a hacer un uso diligente de la contrase&ntilde;a y el nombre de Usuario y a mantener ambos en secreto. Ser&aacute; de exclusiva responsabilidad del Usuario mantener la confidencialidad de su contrase&ntilde;a, asumiendo por tanto cuantos da&ntilde;os, gastos y/o perjuicios de todo tipo se deriven del quebrantamiento de esta obligaci&oacute;n o de la revelaci&oacute;n de la contrase&ntilde;a, as&iacute; como del mal uso que, como consecuencia de la infracci&oacute;n de su deber de custodia, pudiera hacer un tercero.</p>\r\n	<p>\r\n		Cancelaci&oacute;n del acceso, servicios y contenidos. GOTEO podr&aacute;, a su sola discreci&oacute;n, denegar, retirar, suspender y/o bloquear en cualquier momento y sin necesidad de previo aviso el acceso a los contenidos o a la propia plataforma a aquellos Usuarios que incumplan estas Condiciones, pudiendo eliminar su cuenta y toda la informaci&oacute;n y archivos relativos a la misma o, en su caso, denegarle el acceso a tales archivos o a la propia plataforma. GOTEO no asumir&aacute; responsabilidad alguna por la cancelaci&oacute;n del acceso a la misma. GOTEO se reserva la facultad de limitar, total o parcialmente, el acceso a determinados Usuarios, as&iacute; como de cancelar, suspender, bloquear o eliminar determinado tipo de contenidos mediante la utilizaci&oacute;n de instrumentos tecnol&oacute;gicos aptos al efecto, si tuviese conocimiento efectivo de que la actividad o la informaci&oacute;n almacenada y/o difundida es il&iacute;cita o de que lesiona bienes o derechos de un tercero.</p>\r\n	<p>\r\n		Asimismo el Usuario que lo considere oportuno tiene la posibilidad, de informar a GOTEO de aquellos contenidos/usuarios que puedan estar vulnerando dichas condiciones. En caso que GOTEO compruebe la veracidad de dichas denuncias podr&aacute;, seg&uacute;n lo establecido en los p&aacute;rrafos anteriores borrar/cancelar los contenidos/usuarios denunciados.</p>\r\n	<p>\r\n		Comunicaciones y notificaciones: Todas las comunicaciones y notificaciones realizadas se considerar&aacute;n eficaces a todos los efectos cuando se realicen a trav&eacute;s de correo electr&oacute;nico al e-mail que haya podido suministrar el Usuario. El Usuario reconoce expresamente que dichos datos han sido suministrados por &eacute;l mismo y son del todo veraces.</p>\r\n	<p>\r\n		Baja de la plataforma: En el caso de que el Usuario quiera <a href="http://www.goteo.org//user/leave">darse de baja</a> de la plataforma puede realizarlo desde la casilla habilitada a tal efecto. En ese caso su perfil ser&aacute; borrado si bien los contenidos subidos por el usuario permanecer&aacute;n en la misma.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>TERCERO: PROPIEDAD INTELECTUAL E INDUSTRIAL</strong></span></p>\r\n	<p>\r\n		El contenido, as&iacute; como la informaci&oacute;n objeto de propiedad intelectual cuya titularidad corresponda a GOTEO o a los Usuarios registrados puesta a disposici&oacute;n en la plataforma (salvo que no se especifique expresamente otra cosa) podr&aacute; reproducirse, comunicarse p&uacute;blicamente, transformarse o extraerse libremente de forma no exclusiva, de manera total o parcial, por cualquier persona, en cualquier formato, sin ninguna restricci&oacute;n temporal ni territorial y, para cualquier uso leg&iacute;timo posterior, bajo las siguientes condiciones: Deber&aacute; indicarse siempre, y, en todo caso, la autor&iacute;a y deber&aacute; compartirse igual en cumplimiento con la licencia <a href="http://creativecommons.org/licenses/by-sa/3.0/deed.es">Creative Commons 3.0 By - SA</a> que rige en la presente plataforma.</p>\r\n	<p>\r\n		Asismismo al tratarse de una plataforma dedicada al procom&uacute;n la caracter&iacute;stica de los proyectos que se proponen y apoyan a trav&eacute;s de la misma, es la elecci&oacute;n de licencias abiertas quedando las mismas a decisi&oacute;n del usuario que proponga el proyecto entre un listado a propuesta de los responsables de GOTEO.</p>\r\n	<p>\r\n		En cuanto a los derechos de propiedad industrial que pudieran corresponder a dichos contenidos, as&iacute; como todas las marcas, nombres comerciales o cualquier otro signo distintivo son propiedad de GOTEO o de sus leg&iacute;timos propietarios, quedando reservados todos los derechos sobre los mismos.</p>\r\n	<p>\r\n		GOTEO no ser&aacute; responsable de cualquier perjuicio que pudiera derivarse de la utilizaci&oacute;n de los contenidos, servicios e informaci&oacute;n incluida en este sitio web por parte de los usuarios, o de la infracci&oacute;n por parte de &eacute;stos de cualquier disposici&oacute;n legal vigente.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>CUARTO: MENORES DE EDAD</strong></span></p>\r\n	<p>\r\n		La plena responsabilidad en la determinaci&oacute;n de los concretos contenidos y servicios a los que acceden los menores de edad corresponde a los mayores a cuyo cargo se encuentran. Queda prohibido el acceso y uso del Portal a los menores de edad no autorizados. GOTEO entiende que desde el momento en que un menor de edad accede al Portal, cuenta con el permiso de sus padres, de su tutor o de su representante legal.</p>\r\n	<p>\r\n		Como Internet hace posible el acceso a contenidos que pueden no ser apropiados para menores, se informa a los Usuarios de que existen mecanismos, en particular programas inform&aacute;ticos de filtro y bloqueo, que permiten limitar los contenidos disponibles y, aunque no resultan infalibles, son de especial utilidad para controlar y restringir los materiales a los que pueden acceder los menores.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>QUINTO: COOKIES Y ENLACES</strong></span></p>\r\n	<p>\r\n		GOTEO informa al Usuario que la plataforma utiliza cookies, consider&aacute;ndose tales ficheros de informaci&oacute;n alojados en el propio terminal del Usuario y que sirven para facilitar la navegaci&oacute;n del Usuario por el portal (ej: no solicitar nuevamente Usuario y/o contrase&ntilde;a). En ning&uacute;n caso las cookies recoger&aacute;n ni realizar&aacute;n ning&uacute;n tipo de tratamiento de datos de car&aacute;cter personal. De todas formas, el Usuario tiene la posibilidad de configurar el navegador de tal modo que impida la instalaci&oacute;n de estos archivos.</p>\r\n	<p>\r\n		GOTEO no asume ninguna responsabilidad sobre los enlaces externos que, en su caso, pudieran incluirse en el portal, ya que no tiene ning&uacute;n tipo de control sobre los mismos, por lo que el Usuario accede bajo su exclusiva responsabilidad al contenido y en las condiciones de uso que rijan en los mismos.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>SEXTO: POLITICA DE PRIVACIDAD</strong></span></p>\r\n	<p>\r\n		GOTEO protege los datos personales seg&uacute;n lo establecido en la Ley Org&aacute;nica de Protecci&oacute;n de Datos y el Reglamento de Medidas de Seguridad. La informaci&oacute;n sobre la protecci&oacute;n de datos personales se encuentra recogida en la Pol&iacute;tica de Privacidad.</p>\r\n	<p>\r\n		A tal fin ha adoptado las medidas necesarias para evitar la alteraci&oacute;n, p&eacute;rdida, tratamiento o acceso no autorizado de los datos personales, habida cuenta en todo momento del estado de la tecnolog&iacute;a, no obstante, el Usuario debe ser consciente de que las medidas de seguridad en Internet no son inexpugnables.</p>\r\n	<p>\r\n		En el caso de que se incluyan en la plataforma datos de car&aacute;cter personal referentes a personas f&iacute;sicas distintas deber&aacute;, con car&aacute;cter previo a su inclusi&oacute;n informarles de los extremos contenidos en la <a href="http://www.goteo.org/legal/privacy">Pol&iacute;tica de Privacidad</a>.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>SEPTIMO: DURACI&Oacute;N Y TERMINACI&Oacute;N</strong></span></p>\r\n	<p>\r\n		La plataforma tiene, en principio, una duraci&oacute;n indefinida. GOTEO, no obstante, est&aacute; autorizada para dar por terminada o suspender la plataforma en cualquier momento. Cuando ello sea razonablemente posible, GOTEO advertir&aacute; previamente la terminaci&oacute;n o suspensi&oacute;n de la Comunidad a fin de que los Usuarios puedan retirar sus contenidos.</p>\r\n	<p>\r\n		&nbsp;</p>\r\n	<p>\r\n		<span class="estatic-blue-green"><strong>OCTAVO: LEGISLACI&Oacute;N APLICABLE</strong></span></p>\r\n	<p>\r\n		La &nbsp;normativa vigente determinar&aacute; las leyes que deban regir y la jurisdicci&oacute;n que deba conocer de las relaciones entre GOTEO y los Usuarios.</p>\r\n</div>\r\n');
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Entradas para la portada' AUTO_INCREMENT=4 ;
...
(2, 2, 'Breaking Bad', 'Falta poc per estrenar una nova sessió de breaking bad. No sigueu impacients, quan tinguem informació us tindrem informats de les novetats.', NULL, NULL, '2012-10-31', 1, 1, 0, 0, 0, NULL),
(3, 1, 'Estrenem Blog de Breaking Bad', '<p>\r\n	Per f&iacute; podem veure els resultats del treball del equip de la UdG amb aquesta magn&iacute;fica p&agrave;gina web.<br />\r\n	Esperem que us agradi a tots.<br />\r\n	<br />\r\n	Carlos Velasco</p>\r\n', '', NULL, '2012-11-06', 1, 1, 1, 1, 1, '');
...
--
-- Volcado de datos para la tabla `post_image`
--

INSERT INTO `post_image` (`post`, `image`) VALUES
(3, 2);
...
('login-banner-header', 'Descobreix tot sobre la serie<br /><span class="greenblue">Breaking Bad</span>', 1, 'banners'),
...
('open-banner-header', '<div class="modpo-open">Clica</div><div class="modpo-percent">Dona el teu soport</div><div class="modpo-whyopen">%s</div>', 1, 'banners'),
...
('carlos', 'carlos', NULL, 'carlos@hotmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2012-10-24 16:36:45', '2012-10-24 16:43:03', 'bd021ac6283a0e401a31b456cea6a44a', 0, 1),
('root', 'Super administrador', '', 'root_goteo@doukeshi.org', '0', '', '', 1, 91, '', '', '', '', '', '', 0, '2011-08-31 17:54:11', '2012-10-24 16:42:03', '61aa85ea9169c68babfa5b8bdb44097broot_goteo@doukeshi.org', 1, 1);
...
('carlos', 'admin', '*', '2012-10-31 14:23:01'),
('carlos', 'checker', '*', '2012-10-31 14:24:59'),
('carlos', 'superadmin', '*', '2012-10-31 14:24:27'),
('carlos', 'user', '*', '2012-10-24 16:36:45'),
('root', 'admin', '*', NULL),
('root', 'checker', '*', NULL),
('root', 'root', '*', NULL),
