...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2012 a las 17:27:43
...
(16, 'Todd', 'Jesse Plemons', 'secundari', 'És un empleat de "Vamonos pest control" que assisteix a en <a href="/cast/actor/1">Walt</a> i <a href="/cast/actor/3">Jesse</a> en la seva refundació del negoci de fabricació de metaenfetamina.', ''),
...
(18, 'Vince Gilligan', 'Vince Gilligan', 'altres', '<a href="#">Creador</a> i <a href="#">productor executiu</a>. (nascut el 10 de febrer de 1967) és un escriptor, director i productor nord-americà. És el creador de la sèrie de televisió <a href="/">Breaking Bad</a>. També ha treballat en la reeixida sèrie Expediente X i Els Pistolers Solitaris.', ''),
(19, 'Mark Johnson', 'Mark Johnson ', 'altres', '<a href="#">Productor executiu</a>. (nascut el 27 de desembre 1945) és un productor de cinema nord-americà. Johnson va guanyar el <a href="/story">premi</a> de Millor Pel • lícula de l''Acadèmia per a la producció de drama 1988 Rain Man, protagonitzada per Dustin Hoffman i Tom Cruise. La pel • lícula, guanyadora de quatre <a href="/story">premis Oscar</a>, també un Globus d''Or com a millor Pel • lícula.', '');
...
(14, 14, 2, '"Negre y Blau", la balada d''en Heisenberg', 'Mentre en <a href="/cast/actor/1">Walt</a> vol aprofitar la reputació d''en <a href="/cast/actor/3">Jesse</a> com a senyor de la droga sense escrúpols per ampliar el seu àmbit d''actuació, el primer contacte d''en <a href="/cast/actor/5">Hank</a> amb l''alt risc de l''oficina antidroga d''El Paso el deixa molt tocat.'),
...
(21, 21, 3, 'No més', 'Arrenca la <a href="/season/3">tercera temporada</a> de <a href="/">"Breaking Bad"</a>, en la qual en <a href="/cast/actor/1">Walt</a> patirà les conseqüències de les seves activitats delictives.'),
(22, 22, 3, 'Caball sense nom', 'En <a href="/cast/actor/1">Walt</a> és capaç de qualsevol cosa per fer que la família torni a estar unida. D''altra banda, en <a href="/cast/actor/3">Jesse</a> decideix fer una important inversió del tot inesperada'),
(23, 23, 3, 'Em tiro en Ted', 'En <a href="/cast/actor/1">Walt</a> li diu a la <a href="/cast/actor/2">Skyler</a> que accepti els diners, justificant que tot el que ha fet ha estat pensant en el futur dels seus fills. La reacció de la <a href="/cast/actor/2">Skyler</a> no serà l''esperada ni de bon tros...'),
(24, 24, 3, 'Semàfor verd', 'En <a href="/cast/actor/5">Hank</a> continua sense prestar atenció a la trucada a El Paso després d''anotar-se uns quants avenços en la seva investigació en el "cas Heisenberg". Mentrestant, en <a href="/cast/actor/3">Jesse</a> vol tornar a treballar.'),
(25, 25, 3, 'Més', 'En <a href="/cast/actor/1">Walt</a> s''ocupa de les conseqüències de l''accident d''avió i una nova amenaça s''interposa en el seu camí. Mentrestant, la <a href="/cast/actor/2">Skyler</a> considera quins són els millors passos que cal seguir'),
(26, 26, 3, 'Al capvespre', 'En <a href="/cast/actor/1">Walt</a> comença a treballar al seu nou laboratori i coneix qui serà el seu nou assistent. Els cosins mexicans reapareixen però no es mouen del restaurant del <a href="/cast/actor/8">Gus</a>. En <a href="/cast/actor/5">Hank</a> segueix amb la seva investigació i el porta al <a href="/cast/actor/3">Jesse</a>. En <a href="/cast/actor/1">Walt</a> entrarà en escena.'),
(27, 27, 3, 'Un minut', 'En <a href="/cast/actor/5">Hank</a> passa comptes amb en <a href="/cast/actor/3">Jesse</a> després d''involucrar la seva parella en un horrible accident que resulta fictici. D''altra banda, al laboratori, el nou assistent d''en <a href="/cast/actor/1">Walter</a> no se''n surt amb els primers experiments'),
(28, 28, 3, 'Et veig', 'En <a href="/cast/actor/5">Hank</a> ingressa a l''hospital després de rebre 4 trets. Pel que fa al laboratori, en <a href="/cast/actor/1">Walt</a> ha de dir-li al Gale que prescindeix dels seus serveis.'),
(29, 29, 3, 'Kafkià', 'Mentre en <a href="/cast/actor/5">Hank</a> segueix ingressat, la <a href="/cast/actor/2">Skyler</a> trama els seus plans. En <a href="/cast/actor/1">Walt</a> i en <a href="/cast/actor/8">Gus</a> sembla que s''avenen cada cop més. El <a href="/cast/actor/3">Jesse</a>, per la seva banda, busca noves oportunitats.'),
(30, 30, 3, 'La mosca', 'En <a href="/cast/actor/1">Walt</a> es nega a seguir amb més experiments fins que no s''aïlli un agent contaminant que fluctua pel laboratori. En <a href="/cast/actor/3">Jesse</a> intenta de totes totes que en Walt reconsideri aquesta situació.'),
(31, 31, 3, 'Albuquerque', 'La <a href="/cast/actor/2">Skyler</a> s''involucra cada cop més en el negoci d''en <a href="/cast/actor/1">Walt</a>. En <a href="/cast/actor/5">Hank</a> lluita per a la seva recuperació. En <a href="/cast/actor/3">Jesse</a> agafa un rol actiu a la seva nova empresa.'),
(32, 32, 3, 'Mitges tintes', 'En contra de la paraula del <a href="/cast/actor/1">Walt</a>, el <a href="/cast/actor/3">Jesse</a> tira endavant la seva decisió. En <a href="/cast/actor/1">Walt</a> sap que en <a href="/cast/actor/3">Jesse</a> corre perill i decideix prendre part en l''assumpte.'),
(33, 33, 3, 'Tot o res', 'En <a href="/cast/actor/1">Walt</a> negocia alguna mena de tracte amb en <a href="/cast/actor/8">Gus</a> per la seva seguretat i la d''en <a href="/cast/actor/3">Jesse</a>.'),
(34, 34, 4, 'Cúter', 'En <a href="/cast/actor/1">Walt</a> i en <a href="/cast/actor/3">Jesse</a> esperen ansiosament el pròxim moviment d''en <a href="/cast/actor/8">Gus</a>, el seu cap de narcotraficants. Per la seva banda, la <a href="/cast/actor/2">Skyler</a> descobreix que en <a href="/cast/actor/1">Walt</a> ha desaparegut i inicia una recerca desesperada.'),
(35, 35, 4, '38 snub', 'En <a href="/cast/actor/1">Walt</a> decideix comprar-se un revòlver per protegir-se i en <a href="/cast/actor/3">Jesse</a> ha de trampejar el seu sentiment de culpa en reviure l''amistat amb en Badger i l''Skinny Pete. D''altra banda, la <a href="/cast/actor/2">Skyler</a> mira de comprar un túnel d''autorentat de cotxes i la seva germana, ha de fer front al rebuig que sent en <a href="/cast/actor/5">Hank</a> per la seva discapacitat.'),
(36, 36, 4, 'Dia de protes obertes', 'En <a href="/cast/actor/1">Walt</a> està preocupat perquè en <a href="/cast/actor/8">Gus</a> manté el laboratori sota vigilància i perquè l''estat mental d''en <a href="/cast/actor/3">Jesse</a> és cada vegada més delicat. D''altra banda, la <a href="/cast/actor/2">Skyler</a> fa més pressió per comprar el túnel d''autorentat de cotxes, que servirà de tapadora per blanquejar diners.'),
(37, 37, 4, 'Esquemes', 'La <a href="/cast/actor/2">Skyler</a> s''inventa una història d''allò més elaborada per justificar la seva situació financera i en <a href="/cast/actor/1">Walt</a> s''inquieta en descobrir que en <a href="/cast/actor/5">Hank</a> ha obert una altra investigació. Per la seva banda, en <a href="/cast/actor/3">Jesse</a> només pot pensar a fer festes, fet que desperta la curiositat d''en <a href="/cast/actor/8">Gus</a>.'),
(38, 38, 4, 'Vigilant', 'En <a href="/cast/actor/1">Walt</a> creu que estan a punt d''assassinar el seu company i en <a href="/cast/actor/3">Jesse</a> i en <a href="/cast/actor/9">Mike</a> fan una sortida perillosa. D''altra banda, en <a href="/cast/actor/1">Walt</a> i la <a href="/cast/actor/2">Skyler</a> compren oficialment el túnel d''autorentat de cotxes i en <a href="/cast/actor/5">Hank</a> decideix tancar la investigació.'),
(39, 39, 4, 'Arraconat', 'Quan la <a href="/cast/actor/2">Skyler</a> sospita que en <a href="/cast/actor/1">Walt</a> no li diu la veritat, pren una actitud freda i purament professional cap a ell. Mentrestant, en <a href="/cast/actor/8">Gus</a> s''acosta a en <a href="/cast/actor/3">Jesse</a>, que demostra que és un home de vàlua per a en <a href="/cast/actor/9">Mike</a> i per a l''empresa d''en <a href="/cast/actor/8">Gus</a>.'),
(40, 40, 4, 'Un gos problemàtic', 'Amb la nova operació, en <a href="/cast/actor/1">Walt</a> col•loca a la <a href="/cast/actor/2">Skyler</a> en una situació difícil, i mentre en <a href="/cast/actor/1">Walt</a> mira de protegir-se d''en <a href="/cast/actor/8">Gus</a>, en <a href="/cast/actor/3">Jesse</a> accepta una proposició perillosa.'),
(41, 41, 4, 'Germans', 'Mentre en <a href="/cast/actor/5">Hank</a> mostra indicis que en <a href="/cast/actor/8">Gus</a> és l''element central del tràfic de metadona d''Alburquerque, en <a href="/cast/actor/1">Walt</a> creu que l''assassinaran, i també a en <a href="/cast/actor/3">Jesse</a>, per protegir el seu cap. Per la seva banda, en <a href="/cast/actor/8">Gus</a> refusa l''exigència del càrtel mexicà d''aturar les seves activitats com a narcotraficant i contraataca.'),
(42, 42, 4, 'Error', ''),
(43, 43, 4, 'Salut', ''),
...
(1, 'nueva entrada blog BreakingBad (admin)', '/admin/blog', '2012-11-11 12:50:47', 'admin', 'admin', 'El admin <a href="/user/profile/carlos" class="blue" target="_blank">carlos</a> ha <span class="red">Publicado</span> en el blog BreakingBad la entrada "<a href="/blog/1" class="grey" target="_blank">Primer blog</a>"', NULL),
(2, 'Primer blog', '/blog/1', '2012-11-11 12:50:47', 'public', 'BreakingBad', '<p>\r\n	yeah</p>', NULL);
...
('about', 'Sobre BreakingBad', 'Sobre BreakingBad', '/about'),
...
('community', 'Comunidad BreakingBad', 'Bienvenido/a al <span class="greenblue">río</span>. Desde aquí se puede seguir cómo fluye la actividad de BreakingBad.', '/community'),
...
('legal', 'Legales', 'Términos legales de BreakingBad', '/about/legal'),
...
('team', 'Equipo', 'Sobre la gente que impulsa BreakingBad', '/about/team'),
('terms', 'Condiciones de uso', 'Reglas del juego para el <span class="greenblue">buen funcionamiento</span> <br>de la <span class="greenblue">comunidad BreakingBad</span>', '/legal/terms'),
...
('faq-main-section-header', 'Una aproximación a BreakingBad', NULL, 'faq'),
...
('feed-head-BreakingBad', 'BreakingBad', NULL, 'community'),
...
('feed-new_project', '<span class="red">Nuevo proyecto en BreakingBad</span>, desde ahora tenemos 40 días para apoyarlo!', 1, 'feed'),
...
('feed-new_user', 'Nuevo usuario en BreakingBad %s', 1, 'feed'),
...
('form-project_waitfor-cancel', 'Finalmente hemos desestimado la propuesta para publicarla en BreakingBad, te invitamos a intentarlo con otra idea o concepto.', NULL, 'dashboard'),
...
('leave-process-fail', 'No hemos podido completar el proceso para darte de baja. Por favor, contáctanos a hola@BreakingBad.org', NULL, 'register'),
...
('login-banner-header', 'Accede a la comunidad BreakingBad<br /><span class="greenblue">100% abierto</span>', 1, 'banners'),
...
('mandatory-project-field-media', 'Recomendamos poner un vídeo para mejorar la valoración del proyecto a la hora de decidir si publicarlo o no en BreakingBad.', NULL, 'overview'),
...
('oauth-BreakingBad-openid-sync-password', 'Estás intentando vincular una cuenta ya existente en BreakingBad con un proveedor externo. Esto te permitirá entrar en BreakingBad con un solo clic en el futuro.<br/>Esta primera vez deberás proporcionar la contraseña de tu cuenta en BreakingBad para confirmar tu identidad.', 1, 'login'),
('oauth-BreakingBad-user-not-exists', 'Ese usuario no existe en BreakingBad', NULL, 'login'),
('oauth-BreakingBad-user-password-exists', 'Ese usuario ya existe en BreakingBad', NULL, 'login'),
...
('oauth-login-welcome-from', 'Bienvenido/a a BreakingBad! Comprueba tu nombre de usuario y email para finalizar el proceso. En caso de que no se haya podido importar el email o lo cambies por otro, recibirás un correo electrónico con un link de activación para comprovar su validez.', NULL, 'login'),
...
('profile-field-contribution', 'Qué puedes aportar a BreakingBad', NULL, 'profile'),
...
('profile-my_worth-header', 'Mi caudal en BreakingBad', NULL, 'public_profile'),
...
('regular-header-about', 'Sobre BreakingBad', NULL, 'general'),
...
('regular-main-header', 'BreakingBad.org', NULL, 'general'),
...
('regular-share-facebook', 'BreakingBad en Facebook', NULL, 'general'),
...
('social-account-facebook', 'http://www.facebook.com/pages/BreakingBad/268491113192109', NULL, 'social'),
('social-account-google', 'https://plus.google.com/b/116559557256583965659/', NULL, 'social'),
('social-account-identica', 'http://identi.ca/BreakingBadfunding', NULL, 'social'),
('social-account-linkedin', 'Página BreakingBad LinkedIn', NULL, 'social'),
('social-account-twitter', 'http://twitter.com/BreakingBadfunding', NULL, 'social'),
...
('tooltip-dashboard-user-change_email', 'Desde aquí puedes cambiar la dirección de correo electrónico en que recibes los mensajes de BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-change_password', 'Desde aquí puedes cambiar la contraseña con que accedes a BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-confirm_email', 'Confirma la nueva dirección de correo electrónico en que quieres recibir los mensajes de BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-confirm_password', 'Confirma la nueva contraseña con que quieres acceder a BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-new_email', 'Indica la nueva dirección de correo electrónico en que quieres recibir los mensajes de BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-new_password', 'Escribe la nueva contraseña con que quieres acceder a BreakingBad.', NULL, 'general'),
('tooltip-dashboard-user-user_password', 'Escribe la contraseña actual con que accedes a BreakingBad.', NULL, 'general'),
...
('tooltip-project-category', 'Selecciona tantas categorías como creas necesario para describir el proyecto, basándote en todo lo que has descrito arriba. Mediante estas palabras clave lo podremos hacer llegar a diferentes usuarios de BreakingBad.', NULL, 'overview'),
('tooltip-project-comment', '¿Tienes dudas o comentarios para que las lea el administrador de BreakingBad? Éste es lugar para explicar alguna parte de lo que has escrito de la que no estás seguro,  para proponer mejoras, etc.', NULL, 'preview'),
...
('tooltip-project-contract_data', 'Ya sea como persona física o bien jurídica, es necesario que alguien figure como promotor/a del proyecto, y también para la interlocución con el equipo de BreakingBad. No tiene que coincidir necesariamente con el perfil de usuario del apartado anterior.', NULL, 'personal'),
('tooltip-project-contract_email', 'Dirección de correo electrónica principal asociada al proyecto. Aquí recibirás las notificaciones y mensajes del equipo de BreakingBad en relación al proyecto propuesto.', NULL, 'personal'),
...
('tooltip-project-costs', 'Cuanto más precisión en el desglose mejor valorará BreakingBad la información general del proyecto. ', NULL, 'costs'),
...
('tooltip-project-supports', 'En BreakingBad los proyectos pueden recibir otro tipo de ayudas además de aportaciones monetarias. Hay gente que a lo mejor no puede ayudar económicamente pero sí con su talento, tiempo, energía, etc.', NULL, 'supports'),
...
('tooltip-user-about', 'Como red social, BreakingBad pretende ayudar a difundir y financiar proyectos interesantes entre el máximo de gente posible. Para eso es importante la información que puedas compartir sobre tus habilidades o experiencia (profesional, académica, aficiones, etc).\r\n', NULL, 'profile'),
...
('tooltip-user-facebook', 'Esta red social puede ayudar a que difundas proyectos de BreakingBad que te interesan entre amigos y familiares.', NULL, 'profile'),
...
('tooltip-user-identica', 'Este canal puede ayudar a que difundas proyectos de BreakingBad entre la comunidad afín al software libre.', NULL, 'profile'),
...
('tooltip-user-linkedin', 'Esta red social puede ayudar a que difundas proyectos de BreakingBad que te interesan entre contactos profesionales.', NULL, 'profile'),
('tooltip-user-location', 'Este dato es importante para poderte vincular con un grupo local de BreakingBad.', NULL, 'profile'),
('tooltip-user-name', 'Tu nombre o nickname dentro de BreakingBad. Lo puedes cambiar siempre que quieras (ojo: no es lo mismo que el login de acceso, que ya no se puede modificar).', NULL, 'profile'),
('tooltip-user-twitter', 'Esta red social puede ayudar a que difundas proyectos de BreakingBad de manera ágil y viral.', NULL, 'profile'),
...
('user-login-required', 'Debes iniciar sesión para interactuar con la comunidad de BreakingBad', NULL, 'bluead'),
...
('validate-project-field-costs', 'Recomendamos desglosar hasta 5 costes diferentes para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'costs'),
('validate-project-field-currently', 'Indica el estado del proyecto para mejorar la valoración del mismo, de cara a determinar si publicarlo en BreakingBad.', NULL, 'overview'),
...
('validate-project-value-keywords', 'Indica un mínimo de 5 palabras clave del proyecto para mejorar la valoración del mismo, de cara a determinar si publicarlo en BreakingBad.', NULL, 'overview'),
...
('validate-user-field-about', 'Cuenta algo sobre ti, para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
('validate-user-field-avatar', 'Pon una imagen de perfil para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
('validate-user-field-contribution', 'Explica qué podrías aportar en BreakingBad para mejorar la valoración del proyecto de cara a determinar si publicarlo en la plataforma.', NULL, 'profile'),
('validate-user-field-facebook', 'Pon tu cuenta de Facebook para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
('validate-user-field-interests', 'Selecciona algún interés para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
('validate-user-field-keywords', 'Indica hasta 5 palabras clave que te definan, para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
...
('validate-user-field-name', 'Pon tu nombre completo para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile'),
...
('validate-user-field-webs', 'Pon tu página web para mejorar la valoración del proyecto de cara a determinar si publicarlo en BreakingBad.', NULL, 'profile');
...
(1, 'Mensaje de contacto', 'Plantilla para un mensaje de contacto desde BreakingBad', 'Contacto desde BreakingBad: %SUBJECT%', ''),
...
(4, 'Mensaje entre usuarios', 'Mensaje de un usuario a otro desde la página de perfil del destinatario', 'Mensaje personal de %USERNAME% desde BreakingBad', ''),
(5, 'Confirmación de registro', 'Plantilla del mensaje de confirmación de registro', 'Confirmación de registro en BreakingBad', ''),
(6, 'Recuperar contraseña', 'Plantilla para el mensaje al solicitar la recuperación de contraseña', 'Petición de recuperación de contraseña en BreakingBad', ''),
(7, 'Cambio de email', 'Plantilla del mensaje al cambiar el email', 'Petición de cambio de email en BreakingBad', ''),
...
(9, 'Darse de baja', 'Plantilla para el mensaje al solicitar la baja', 'Solicitud de baja en BreakingBad', ''),
...
(15, 'Agradecimiento cofinanciadores si supera primera', 'Mensaje a los cofinanciadores de un proyecto cuando este supera la primera ronda', 'El proyecto %PROJECTNAME% ha pasado a segunda ronda en BreakingBad', ''),
...
(17, 'Aviso cofinanciadores proyecto fallido', 'Mensaje a los cofinanciadores de un proyecto cuando este caduca sin conseguir el mínimo', 'El proyecto %PROJECTNAME% no ha logrado su objetivo mínimo en BreakingBad :(', ''),
...
(27, 'Aviso a los talleristas', 'Plantilla del mensaje a los usuarios que aun tienen su email como contraseña', 'El crowdfunding de BreakingBad.org en marcha', ''),
...
CREATE TABLE IF NOT EXISTS `temporades` (
  ...
  `descripcio` varchar(2500) NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 'Primera temporada', 'A un lluitador professor de química <a href="/cast/actor/1">Walter White (Cranston)</a> li diagnostiquen un càncer inoperable de pulmó avançat. En un viatge al costat del seu agent cunyat de la DEA, <a href="/cast/actor/5">Hank (Dean Norris)</a>, <a href="/cast/actor/1">Walter</a> veu un antic alumne seu, en <a href="/cast/actor/3">Jesse (Pau)</a>, fugint de l''escena d''un laboratori de metamfetamina. Més tard, en <a href="/cast/actor/3">Jesse</a> contacta amb en <a href="/cast/actor/1">Walter</a> i idea un pla per convertir-se en socis en un intent de combinar les seves habilitats per elaborar i distribuir metamfetamina. <a href="/cast/actor/1">Walter</a> diu que necessita diners perquè vol donar estabilitat financera a la seva dona embarassada, <a href="/cast/actor/2">Skyler (Gunn)</a> i el seu fill discapacitat, i per pagar el seu tractament contra el càncer. Durant els seus primers dies es troben amb una sèrie de problemes amb els narcotraficants locals.'),
(2, 'Segona temporada', 'En <a href="/cast/actor/1">Walter</a> es segueix trobant davant insuperables despeses mèdiques del seu tractament contra el càncer. Malgrat haver tingut diverses males experiències, mentre feia la producció de metamfetamina amb en <a href="/cast/actor/3">Jesse</a>, <a href="/cast/actor/1">Walter</a> es compromet a reunir-se amb la seva parella. Els dos comencen a produir metamfetamina, però tenen múltiples problemes. Un amic d’en <a href="/cast/actor/3">Jesse</a>, Badger (Matt L. Jones), és arrestat mentre fa la venda de metamfetamina en una operació encoberta. <a href="/cast/actor/1">Walter</a> contracta un advocat, <a href="/cast/actor/7">Saul Goodman (Bob Odenkirk)</a>, per ajudar-lo. En <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a> produeixen metamfetamina en una autocaravana en ple desert durant quatre dies. Més tard, Combo, un altre dels amics de <a href="/cast/actor/3">Jesse</a> i distribuïdors, és assassinat per una banda rival per vendre metamfetamina al seu territori. <a href="/cast/actor/7">Saül</a> els suggereix que els dos trobin un nova manera de fer distribució. Durant la temporada, en <a href="/cast/actor/3">Jesse</a> ha estat establint una relació amb la seva veïna i propietària de la casa que té llogada, <a href="/cast/actor/14">Jane</a>. La <a href="/cast/actor/14">Jane</a> s''està recuperant d''una addicció, però els dos recauen i comencen a consumir heroïna. <a href="/cast/actor/7">Saül</a> els troba un nou soci comercial, <a href="/cast/actor/8">Gus Fring (Giancarlo Esposito)</a>, que està disposat a pagar $ 1,2 milions per als 38 quilos de metamfetamina produïda. <a href="/cast/actor/1">Walter</a> precipitadament lliura el producte a <a href="/cast/actor/8">Gus</a>, però es perd el naixement de la seva filla. <a href="/cast/actor/1">Walt</a> visita la casa d’en <a href="/cast/actor/3">Jesse</a> i veu que la <a href="/cast/actor/14">Jane</a> vomita mentre dorm, però no fa res per salvar-la. <a href="/cast/actor/2">Skyler</a> s''enfronta a <a href="/cast/actor/1">Walter</a> per les seves freqüents absències i excuses. Ella comença a reconstruir la seva vida, i li exigeix que es separin.'),
(3, 'Tercera temporada', '<a href="/cast/actor/1">Walter</a> vol reunir a la seva família, però <a href="/cast/actor/2">Skyler</a> segueix sospitant de la segona vida d’en <a href="/cast/actor/1">Walter</a>. <a href="/cast/actor/1">Walter</a> creu que pot millorar la relació que hi ha entre ells en confessar-l’hi que ell és productor de metamfetamina. La <a href="/cast/actor/2">Skyler</a> està consternada per la confessió i exigeix un divorci formal. Mentrestant, <a href="/cast/actor/8">Gus</a> s''ofereix a pagar <a href="/cast/actor/1">Walter</a> tres milions de dòlars pels tres mesos del seu servei. Fins i tot s''ofereix a proporcionar-li a en <a href="/cast/actor/1">Walter</a> una planta de producció i un assistent de laboratori brillant, Gale (David Costabile). En <a href="/cast/actor/3">Jesse</a> continua produint i venent metamfetamina per si mateix. En <a href="/cast/actor/5">Hank</a> investiga en <a href="/cast/actor/3">Jesse</a> i poc a poc recol•lecta proves per arrestar-lo. En <a href="/cast/actor/3">Jesse</a> amenaça en <a href="/cast/actor/1">Walter</a> en explicar-ho tot a la policia si l’ arresten, però en <a href="/cast/actor/1">Walter</a> li ofereix la posició d’en Gale al laboratori. Després d''obtenir la posició, <a href="/cast/actor/3">Jesse</a> comença a robar mètodes del laboratori i vendre en secret. <a href="/cast/actor/3">Jesse</a> té una relació sentimental amb una dona que coneix en al seu grup de rehabilitació i s''assabenta que el seu germà petit, de 11 anys, va ser posat per en <a href="/cast/actor/8">Gus</a> i els seus traficants al carrer per matar en Combo. <a href="/cast/actor/3">Jesse</a> decideix venjar en Combo. En <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a> demanen ajuda per escapar de la ira d’en <a href="/cast/actor/8">Gus</a>. <a href="/cast/actor/8">Gus</a> comença en perdre la confiança d’en <a href="/cast/actor/1">Walter</a>  i li pregunta a en Gale si li interessaria fer-se càrrec del laboratori i ordena als seus sequaços matar <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a>. En <a href="/cast/actor/1">Walter</a> és segrestat, però dóna instruccions a en <a href="/cast/actor/3">Jesse</a> de matar en Gale per ser els únics cuiners de metamfetamina.'),
(4, 'Quarta temporada', 'En <a href="/cast/actor/3">Jesse</a> segueix les instruccions d’en <a href="/cast/actor/1">Walter</a> mata en Gale. En <a href="/cast/actor/8">Gus</a> decideix disciplinar-los amb l''aplicació de polítiques més estrictes en el laboratori. També intenta trencar l''amistat d’en <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a> assignant-los diferents feines. Mentre en <a href="/cast/actor/1">Walter</a> treballa al laboratori de metamfetamina, en <a href="/cast/actor/3">Jesse</a>, acompanyant d’en <a href="/cast/actor/9">Mike (Jonathan Banks)</a>, es dedica a fer cobraments. En <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a> estan cada vegada més distanciats entre si. Mentrestant, en <a href="/cast/actor/5">Hank</a>, que s’ha estat recuperant del seu últim contacte amb el “cartel”, troba evidències que vinculen la mort d’en Gale amb en <a href="/cast/actor/8">Gus</a>. Ell creu que en <a href="/cast/actor/8">Gus</a> és un important distribuïdor de droga i comença a buscar proves tangibles per presentar càrrecs. En <a href="/cast/actor/8">Gus</a> s''adona dels estrets vincles d’en <a href="/cast/actor/1">Walter</a> amb en <a href="/cast/actor/5">Hank</a> i creu que podria posar en risc la seva operació. En <a href="/cast/actor/8">Gus</a> amenaça en <a href="/cast/actor/1">Walter</a> en matar a tota la seva família. En <a href="/cast/actor/3">Jesse</a> i en <a href="/cast/actor/1">Walter</a> aparten les seves diferències a un costat i es posen d''acord per assassinar en <a href="/cast/actor/8">Gus</a> convencent un antic membre del “cartel” perquè detoni una bomba suïcida, l’Hèctor té èxit, matant-se a si mateix i en <a href="/cast/actor/8">Gus</a>. En <a href="/cast/actor/1">Walter</a> i en <a href="/cast/actor/3">Jesse</a> destrueixen el laboratori de metamfetamina i en <a href="/cast/actor/1">Walter</a> li diu a la seva dona, "jo he guanyar."\r\n'),
(5, 'Cinquena temporada', 'La primera meitat de la temporada es centra en la reactivació de la producció de metamfetamina d’en <a href="/cast/actor/1">Walt</a> i en <a href="/cast/actor/3">Jesse</a>. La història gira entorn el matrimoni deteriorat entre en <a href="/cast/actor/1">Walt</a> i la <a href="/cast/actor/2">Skyler</a>. En <a href="/cast/actor/1">Walt</a> intimida la seva esposa i finalment la porta a un intent de suïcidi per forçar-lo a col•locar els seus fills a casa de la seva germana, perquè estiguin fora de perill.  En <a href="/cast/actor/1">Walt</a>, en <a href="/cast/actor/3">Jesse</a> i en <a href="/cast/actor/9">Mike</a> treballen plegats per refer el negoci desprès de la mort d’en <a href="/cast/actor/8">Gust</a>. Inicialment, en <a href="/cast/actor/1">Walt</a> decideix que no vol posar fi a la seva carrera de producció de metamfetamina i convenç en <a href="/cast/actor/3">Jesse</a> i en <a href="/cast/actor/9">Mike</a> per iniciar un imperi conjuntament. En <a href="/cast/actor/9">Mike</a> s''encarrega de la distribució i cobraments del negoci, mentre que en <a href="/cast/actor/1">Walt</a> i en <a href="/cast/actor/3">Jesse</a> segueixen produint en cases que s’estan fumigant. La  DEA té en <a href="/cast/actor/9">Mike</a> cada vegada més acorralat, i aquest decideix que és hora de sortir del negoci per sempre. Després que Mike es negui a donar a en <a href="/cast/actor/1">Walt</a> els deu noms dels enllaços (nou presos més un advocat) que podrien implicar en <a href="/cast/actor/1">Walt</a> aquest el mata. Mentrestant, en <a href="/cast/actor/3">Jesse</a> segueix se sentint malament per l''assassinat d''un nen després d''un robatori de metilamina i es tanca a casa. En <a href="/cast/actor/1">Walt</a> segueix produint amb en <a href="/cast/actor/16">Todd</a>, un dels membres de la plantilla del fumigador. Fa enviaments de metamfetamina a la República Txeca i hi guanya molts diners. De tota manera, la <a href="/cast/actor/2">Skyler</a> demana a en <a href="/cast/actor/1">Walt</a> "quant serà suficient?" ja que ha acumulat molts diners per comptar i blanquejar. La primera meitat de la temporada acaba mostrant en Hank trobant el llibre que li va donar en Gale a en \r\n<a href="/cast/actor/1">Walt</a> i al veure la línia "Al meu altre favorit WW" a la primera pàgina, es queda comprensió a la cara.\r\n');
...
('blog-main-header', 'ca', 'Blog de BreakingBad'),
('blog-main-header', 'en', 'BreakingBad Blog'),
...
('faq-main-section-header', 'ca', 'Una aproximació a BreakingBad'),
('faq-main-section-header', 'en', 'An approach to BreakingBad'),
...
('feed-head-BreakingBad', 'ca', 'Breaking Bad'),
('feed-head-BreakingBad', 'en', 'BreakingBad'),
...
('feed-new_project', 'ca', '<span class="red">Nou projecte a BreakingBad</span>, des d''ara tens 40 dies per a recolzar aquest projecte'),
('feed-new_project', 'en', '    <span class="red">New BreakingBad project</span>, you''ve got 40 days from today to support this project.'),
...
('feed-new_user', 'ca', 'Nou usuari a BreakingBad %s'),
('feed-new_user', 'en', 'New BreakingBad user, %s'),
...
('form-project_waitfor-cancel', 'ca', 'Finalment hem desestimat la proposta per publicar-la a BreakingBad, et convidem a intentar-ho amb una altra idea o concepte.'),
('form-project_waitfor-cancel', 'en', 'We have decided not to publish your proposal on BreakingBad, though we invite you to try again with a different idea or concept.'),
...
('form-project_waitfor-review', 'en', 'We will get back to you as soon as we''ve had a chance to review your project. At that point, we will either post your project, or suggest ways to make it fit better on BreakingBad.'),
...
('guide-dashboard-user-access', 'ca', 'Des d''aquí pots modificar les dades amb que accedeixes al teu compte de BreakingBad.'),
('guide-dashboard-user-access', 'en', 'You can change the information with which you log in to your BreakingBad account.'),
('guide-dashboard-user-personal', 'ca', 'Només has d''omplir aquestes dades si has creat un projecte i vols que sigui cofinançat i recolzat mitjançant BreakingBad. La informació d''aquest apartat és necessària per contactar-te en cas que obtinguis el finançament, i que així es pugui fer efectiu l''ingrés.'),
('guide-dashboard-user-personal', 'en', 'You should only fill in this data if you have created a project and you want it to be co-financed and supported through BreakingBad. The information in this section is necessary so that we can contact you in the event that you obtain the necessary co-financing, and make the corresponding deposit.'),
...
('guide-dashboard-user-profile', 'ca', 'Tant si vols presentar un projecte com incorporar-te com a cofinanciador/a, per formar part de la comunitat de BreakingBad et recomanem que escriguis el teu text de presentació, que afegeixis links rellevants sobre el que fas i pugis una imatge de perfil amb la qual t''identifiquis.'),
('guide-dashboard-user-profile', 'en', 'Whether you want to create a project or co-finance someone else''s, in order to join the BreakingBad community, we recommend that you carefully edit your presentation text, and include relevant links about what you do as well as a profile image with which you identify'),
('guide-project-comment', 'en', 'guide-project-comment'),
('guide-project-contract-information', 'ca', '<b>A partir d''aquest pas només has d''emplenar les dades si vols que el teu projecte sigui cofinançat i recolzat mitjançant BreakingBad.</b>\r\n<br><br>\r\nLa informació d''aquest apartat és necessària per contactar-te en cas que obtinguis el finançament requerit, i que així es pugui efectuar l''ingrés.'),
('guide-project-contract-information', 'en', '<strong>The only thing left is to fill in your data if you want your project to be co-financed and supported through BreakingBad.</strong><br><br>The information in this section is necessary so that we can contact you if you get the required financing, and be able to make the deposit. In the case of organizations, we recommend that the representative of the organization be formally accredited (for example, by way of the statutes or a certificate of the secretary with an OK from the president, in the case of associations).'),
...
('guide-project-user-information', 'en', '    <strong>In this section, you will enter data for the public part of your user profile. </strong><br><br>Whether you want to create a project or co-finance someone else''s, in order to join the BreakingBad community, we recommend that you carefully edit your presentation text, and include relevant links about what you do as well as a profile image with which you identify.'),
...
('leave-process-fail', 'ca', 'No hem pogut completar el procés per donar-te de baixa. Per favor, contacta''ns a hola@BreakingBad.org'),
('leave-process-fail', 'en', 'We were not able to close the account. Please contact us at hola@BreakingBad.org'),
...
('login-banner-header', 'ca', 'Accedeix a la comunitat BreakingBad<br /><span class="greenblue">100% obert</span>'),
('login-banner-header', 'de', 'Mach mit bei der BreakingBad Community<br /><span class="greenblue">100% offen</span>'),
('login-banner-header', 'en', '    Get access to the <br /><span class="greenblue">100% open</span> BreakingBad community'),
...
('mailer-baja', 'ca', 'No vols rebre més comunicacions de BreakingBad? Pots donar el teu email de baixa mitjançant aquest <a href="%s">link</a>'),
('mailer-baja', 'en', 'If you don''t want to receive more updates form BreakingBad.org, you can unsubscribe your email address with <a href="%s">link</a>'),
('mailer-disclaimer', 'ca', 'BreakingBad és una plataforma digital per al finançament col·lectiu, col·laboració i distribució de recursos per al desenvolupament de projectes socials, culturals, educatius, tecnològics... que contribueixin a l''enfortiment del béns comuns, el codi obert i/o el coneixement lliure.'),
('mailer-disclaimer', 'en', 'BreakingBad this is a translation test'),
...
('mandatory-project-field-media', 'ca', 'Recomanem posar un vídeo per millorar la valoració del projecte a l''hora de decidir si publicar-ho o no a BreakingBad.'),
('mandatory-project-field-media', 'en', 'We recommend uploading a video to facilitate the evaluation of your project by the BreakingBad team.'),
...
('oauth-BreakingBad-openid-sync-password', 'ca', 'Estàs intentant vincular un compte ja existent a BreakingBad amb un proveïdor extern. Això et permetrà entrar a BreakingBad amb un sol clic en el futur.<br>Aquesta primera vegada hauràs de proporcionar la contrasenya del teu compte de BreakingBad per confirmar la teva identitat.'),
('oauth-BreakingBad-openid-sync-password', 'en', 'You''re trying to connect an existing BreakingBad account with an external provider. That will allow you to access BreakingBad with a single click.<br>This time you must provide your BreakingBad account password in order to confirm your identity.'),
('oauth-BreakingBad-user-not-exists', 'ca', 'Aquest usuari no existeix a BreakingBad'),
('oauth-BreakingBad-user-not-exists', 'en', 'That user does not exist in BreakingBad'),
('oauth-BreakingBad-user-password-exists', 'ca', 'Aquest usuari ja existeix a BreakingBad'),
('oauth-BreakingBad-user-password-exists', 'en', 'That user already exists in BreakingBad'),
...
('oauth-login-welcome-from', 'ca', 'Benvingut/da a BreakingBad! Comprova el teu nom d''usuari i email per finalitzar el procés. En cas que no s''hagi pogut importar l''email o ho canviïs per un altre, rebràs un correu electrònic amb un link d''activació per comprovar la seva validesa.'),
('oauth-login-welcome-from', 'en', 'Welcome to BreakingBad. Please check your username and email to finish the process. In case we could not import the email address (or if you change it for another) an email will be sent with an activation link for validation.'),
...
('profile-field-contribution', 'ca', 'Què pots aportar a BreakingBad'),
('profile-field-contribution', 'en', 'What can you offer BreakingBad?'),
...
('profile-my_worth-header', 'ca', 'El meu cabal a BreakingBad'),
('profile-my_worth-header', 'en', 'My flow on BreakingBad'),
...
('regular-header-about', 'ca', 'Sobre BreakingBad'),
('regular-header-about', 'en', 'About BreakingBad'),
...
('regular-header-glossary', 'en', 'Glossary of terms used in BreakingBad'),
...
('regular-main-header', 'ca', 'BreakingBad.org'),
('regular-main-header', 'en', 'BreakingBad.org'),
...
('regular-share-facebook', 'ca', 'BreakingBad al Facebook'),
('regular-share-facebook', 'en', 'BreakingBad on Facebook'),
...
('social-account-facebook', 'ca', 'http://www.facebook.com/pages/BreakingBad/268491113192109'),
('social-account-facebook', 'en', 'http://www.facebook.com/pages/BreakingBad/268491113192109'),
...
('social-account-identica', 'ca', 'http://identi.ca/BreakingBadfunding'),
('social-account-identica', 'en', 'http://identi.ca/BreakingBadfunding'),
('social-account-linkedin', 'en', 'BreakingBad page at Linkedin'),
('social-account-twitter', 'ca', 'http://twitter.com/BreakingBadfunding'),
('social-account-twitter', 'en', 'http://twitter.com/BreakingBadfunding'),
('step-1', 'ca', 'Perfil'),
('step-1', 'en', 'Profile'),
...
('tooltip-dashboard-user-change_email', 'ca', 'Des d''aquí pots canviar l''adreça de correu electrònic on reps els missatges de BreakingBad.'),
('tooltip-dashboard-user-change_email', 'en', 'Change the email address at which you receive messages from BreakingBad.'),
('tooltip-dashboard-user-change_password', 'ca', 'Des d''aquí pots canviar la contrasenya amb que accedeixes a BreakingBad.'),
('tooltip-dashboard-user-change_password', 'en', 'Change your password that you use to log in to BreakingBad.'),
('tooltip-dashboard-user-confirm_email', 'ca', 'Confirma la nova adreça de correu electrònic on vols rebre els missatges de BreakingBad.'),
('tooltip-dashboard-user-confirm_email', 'en', 'Confirm the new email address where you wish to receive messages from BreakingBad.'),
('tooltip-dashboard-user-confirm_password', 'ca', 'Confirma la nova contrasenya amb que vols accedir a BreakingBad.'),
('tooltip-dashboard-user-confirm_password', 'en', 'Confirm the new password with which you want to log in to BreakingBad.'),
('tooltip-dashboard-user-new_email', 'ca', 'Indica la nova adreça de correu electrònic on vols rebre els missatges de BreakingBad.'),
('tooltip-dashboard-user-new_email', 'en', 'Specify the new email address at which you wish to receive messages from BreakingBad.'),
('tooltip-dashboard-user-new_password', 'ca', 'Escriu la nova contrasenya amb que vols accedir a BreakingBad.'),
('tooltip-dashboard-user-new_password', 'en', 'Write the new password that you want to use to log in to BreakingBad'),
('tooltip-dashboard-user-user_password', 'ca', 'Escriu la contrasenya actual amb que accedeixes a BreakingBad.'),
('tooltip-dashboard-user-user_password', 'en', 'Write the current password that you use to log in to BreakingBad'),
...
('tooltip-project-category', 'ca', 'Selecciona tantes categories com creguis necessari per descriure el projecte, basant-te en tot el que has descrit amunt. Mitjançant aquestes paraules clau ho podrem fer arribar a diferents usuaris de BreakingBad.'),
('tooltip-project-category', 'en', 'Choose as many categories as you deem necessary in order to describe the project, based on everything you''ve written above. Your choices will help us get your project out to interested BreakingBad users.'),
('tooltip-project-comment', 'ca', 'Tens dubtes o comentaris per a que els llegeixi l''administrador de BreakingBad? Aquest és el lloc on explicar alguna part del que has escrit de la qual no estiguis segur, per proposar millores, etc.');
INSERT INTO `text` (`id`, `lang`, `text`) VALUES
('tooltip-project-comment', 'en', 'Do you have any doubts or comments for the BreakingBad administrator? This is the place to mention some part of what you have written that you''re not sure about, to suggest improvements, etc.'),
...
('tooltip-project-contract_data', 'ca', 'Ja sigui com a persona física o bé jurídica, és necessari que algú figuri com a promotor/a de el projecte, i també per a la interlocució amb l''equip de BreakingBad. No ha de coincidir necessàriament amb el perfil d''usuari de l''apartat anterior.'),
('tooltip-project-contract_data', 'en', 'Whether it''s a person or legal entity, someone has to be named as the project promoter, as well as the liaison with the BreakingBad team. It doesn''t have to be the same as the user profile from the previous field.'),
('tooltip-project-contract_email', 'ca', 'Adreça de correu electrònic principal associada al projecte. Aquí rebràs les notificacions i missatges de l''equip de BreakingBad en relació al projecte proposat.'),
('tooltip-project-contract_email', 'en', 'Main email address associated with the project.You will receive all the notifications and messages from the BreakingBad team relating to your project proposal at this address.'),
...
('tooltip-project-costs', 'ca', 'Com més precisió en el desglossament millor valorarà BreakingBad la informació general del projecte. '),
('tooltip-project-costs', 'en', 'The more precisely you break down the expenses, the better BreakingBad will be able to evaluate the general information about your project.'),
...
('tooltip-project-social_reward-license', 'ca', 'Aquí has de seleccionar una llicència d''entre cadascuna del grup que es mostren. Et recomanem llegir-les amb calma abans de decidir, però pensa que un aspecte important BreakingBad és que els projectes disposin de llicències el més obertes possible.'),
('tooltip-project-social_reward-license', 'en', 'Choose a license from the group displayed. We recommend that you read through them carefully before deciding, and keep in mind that an important factor for BreakingBad is that projects have the most open licences possible.'),
...
('tooltip-project-supports', 'ca', 'A BreakingBad els projectes poden rebre un altre tipus d''ajudes a més d''aportacions monetàries. Hi ha gent que potser no pugui ajudar econòmicament però sí amb el seu talent, temps, energia, etc.'),
('tooltip-project-supports', 'en', 'In BreakingBad, projects can be supported in other ways besides just monetary. There are people who can''t help economically but have plenty to offer in terms of their talent, time, energy, and more.'),
...
('tooltip-user-about', 'ca', 'Com a xarxa social, BreakingBad pretén ajudar a difondre i finançar projectes interessants entre el màxim de gent possible. Per això és important la informació que puguis compartir sobre les teves habilitats o experiència (professional, acadèmica, aficions, etc). '),
('tooltip-user-about', 'en', 'As a social network, BreakingBad attempts to help spread the word about and finance interesting projects among the largest amount of people possible. To that end, it''s important to share information about your skills and experience (professional, academic, hobbies, etc.)'),
...
('tooltip-user-facebook', 'ca', 'Aquesta xarxa social pot ajudar que difonguis projectes de BreakingBad que t''interessen entre amics i familiars.'),
('tooltip-user-facebook', 'en', 'This social network can help you spread the word about BreakingBad projects that interest you with your friends and family.'),
...
('tooltip-user-identica', 'ca', 'Aquest canal pot ajudar que difonguis projectes de BreakingBad entre la comunitat propera al programari lliure.'),
('tooltip-user-identica', 'en', 'This channel can help you spread the word about BreakingBad projects in the open source community.'),
...
('tooltip-user-linkedin', 'ca', 'Aquesta xarxa social pot ajudar que difonguis projectes de BreakingBad que t''interessen entre contactes professionals.'),
('tooltip-user-linkedin', 'en', 'This social network can help you spread the word about interesting BreakingBad projects with your professional contacts.'),
('tooltip-user-location', 'ca', 'Aquesta dada és important per poder-te vincular amb un grup local de BreakingBad.'),
('tooltip-user-location', 'en', 'This information is important so that we can connect you with a local BreakingBad group.'),
('tooltip-user-name', 'ca', 'El teu nom o nom d''usuari a BreakingBad. Ho pots canviar sempre que vulguis (atenció: no és el mateix que el login d''accés, que ja no es pot modificar).'),
('tooltip-user-name', 'en', 'Your screen name or nickname on BreakingBad. You can change it whenever you like. (Note: it''s not the same as your user name, which cannot be changed.)'),
('tooltip-user-twitter', 'ca', 'Aquesta xarxa social pot ajudar que difonguis projectes de BreakingBad de manera àgil i viral.'),
('tooltip-user-twitter', 'en', 'This social network can help spread the word about BreakingBad projects quickly and virally.'),
...
('user-login-required', 'ca', 'Has d''iniciar sessió per poder interactuar amb la comunitat de BreakingBad'),
('user-login-required', 'en', 'You have to sign in to interact with the BreakingBad community'),
...
('validate-project-field-costs', 'ca', 'Recomanem desglossar fins a 5 costos diferents per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-project-field-costs', 'en', 'We recommend that you break it down into least 5 distinct expenses to make it easier to evaluate your project to see whether it should be published on BreakingBad.'),
('validate-project-field-currently', 'ca', 'Indica l''estat del projecte per millorar-ne la seva valoració, de cara a determinar si publicar-ho a BreakingBad.'),
('validate-project-field-currently', 'en', 'Indicate the current status of the project in order to facilitate the evaluation of the project and to determine whether it should be published on BreakingBad.'),
...
('validate-project-value-keywords', 'ca', 'Indica un mínim de 5 paraules clau del projecte per millorar-ne la seva valoració, de cara a determinar si publicar-ho a BreakingBad.'),
('validate-project-value-keywords', 'en', 'Write down at least five key words about the project that will help facilitate its evaulation by BreakingBad.'),
...
('validate-user-field-about', 'ca', 'Explica alguna cosa sobre tu, per així millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-about', 'en', 'Tell us about yourself so that we can better evaluate your project and determine its suitability for publishing on BreakingBad.'),
('validate-user-field-avatar', 'ca', 'Posa una imatge de perfil per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-avatar', 'en', 'Add a profile image to help us evaluate your project and determine whether it is suitable for publication on BreakingBad.'),
('validate-user-field-contribution', 'ca', 'Explica què podries aportar a BreakingBad, per millorar la valoració del projecte de cara a determinar si publicar-ho en la plataforma.'),
('validate-user-field-contribution', 'en', 'Explain what you could bring to BreakingBad to improve the evaluation of the project to determine whether it should be published on the platform.'),
('validate-user-field-facebook', 'ca', 'Posa el teu compte de Facebook per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-facebook', 'en', 'Add your Facebook user name to help us evaluate your project and whether it is suitable for publication on BreakingBad.'),
('validate-user-field-interests', 'ca', 'Selecciona algun interès per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-interests', 'en', 'Select an interest to help us evaluate your project and determine if it is suitable for publication on BreakingBad.'),
('validate-user-field-keywords', 'ca', 'Indica fins a 5 paraules clau que et defineixin, per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-keywords', 'en', 'Indicate up to 5 key words that define you, to help evaluate your project and decide if it is suitable for publication on BreakingBad.'),
...
('validate-user-field-name', 'ca', 'Posa el teu nom complert per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-name', 'en', 'Enter your complete name to help us evaluate your project and see whether it is suitable for publishing on BreakingBad.'),
...
('validate-user-field-webs', 'ca', 'Posa la teva pàgina web per millorar la valoració del projecte de cara a determinar si publicar-ho a BreakingBad.'),
('validate-user-field-webs', 'en', 'Enter the address of your website to help us evaluate your project and determine if it is suitable for publishing on BreakingBad.');
...
('nurbigay', 'nurbigay', 'micasa', 'nurbigay@hotmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'eeeeeeeeeee', 'cap', 1, NULL, 'res', '', '', '', '', '', NULL, '2012-12-01 22:38:44', '2012-12-02 01:08:46', '606396889d766567270d9f6430a9d438', 0, 1),
('root', 'Super administrador', '', 'root_BreakingBad@doukeshi.org', 'f64dd0d8c9276d87c6d0ae24c5d12571c62ecf16', '', '', 1, 91, '', '', '', '', '', '', 0, '2011-08-31 17:54:11', '2011-12-21 21:45:39', '61aa85ea9169c68babfa5b8bdb44097broot_BreakingBad@doukeshi.org', 1, 1);
